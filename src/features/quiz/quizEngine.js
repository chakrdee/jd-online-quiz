import { questionSets } from '../../data/questions.js';
...
export class QuizEngine {
  static getFirstQuestion(questionSetId) {
    const questions = questionSets[questionSetId];
    const firstQuestion = selectNextQuestion(questions, [], 1);
    return shuffleOptions(firstQuestion);
  }

  static getNextQuestion(questionSetId, usedIds, difficulty) {
    const questions = questionSets[questionSetId];
